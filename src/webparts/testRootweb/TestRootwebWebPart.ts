...
export default class TestRootwebWebPart extends BaseClientSideWebPart<ITestRootwebWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ITestRootwebProps> = React.createElement(
      TestRootweb,
      {
